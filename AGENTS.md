...
16. Exit fullscreen — DOM should be restored to its original state, chat back in its original location, and no leftover divider / control nodes.
17. Check the browser developer console for `[KickFullscreenChat]` log lines if something doesn't work.
