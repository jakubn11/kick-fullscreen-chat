...
- **Toasts are neutral, not themed.** `#kfc-toast` uses a black-on-translucent palette for surfacing internal errors (e.g. "chat panel not found"). It is intentionally distinct from both Kick and the kick-\* family design language.
